...
Schema for the `data` field: `schemas/manus-outputs/pacing-log.schema.json`

Also write the payload to disk:
- `intelligence-db/paid/pacing-log.json` — full pacing-log payload
...
```json
{
  ...
  "task_type": "budget-pacing-tracker",
  "status": "completed",
