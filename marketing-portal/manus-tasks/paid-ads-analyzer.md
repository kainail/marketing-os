...
Schema for the `data` field: `schemas/manus-outputs/meta-performance.schema.json`

Also write the payload to disk:
- `intelligence-db/paid/meta-performance.json` — full meta-performance payload
